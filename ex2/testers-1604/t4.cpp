...
void f (void)
{
    ...
    while(1)
    {
        if (i == uthread_get_quantums(uthread_get_tid()))
        {
            ...
            {
                j++;
                //std::cout << "tester calling sleep from f func" << std::endl;
                uthread_sleep(2);
            }
            if (i == 6 && j == 1)
            {
            ...
            if (i == 8 && j == 2)
            {
                j++;
                cout << "          **f end**" << endl;
                //std::cout << "tester terminating f" << std::endl;
    ...
    while(1)
    {
        if (i == uthread_get_quantums(uthread_get_tid()))
        {
            ...
            if (i == 11 && j == 0)
            {
                j++;
                cout << "          **g end**" << endl;
                //std::cout << "tester terminating g" << std::endl;
                uthread_terminate(uthread_get_tid());
                return;
            }
            if (i == 3 && j == 0)
            {
                //std::cout << "tester calling sleep from g func" << std::endl;
                uthread_sleep(3);
            }
